document.querySelector('.heart').addEventListener('click', function () {
  ...
  xhr.open('GET', 'carta.pdf', true); // Asegúrate de que sea el mismo nombre de tu carta, al nombre escrito en esta línea.
...
document.getElementById("countdown").textContent = "Esperando próxima carta...";
